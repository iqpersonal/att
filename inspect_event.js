...
async function run() {
    ...
    // The event ID from the user's console log
    ...
    console.log(`Fetching event ${eventId} for ${coordinatorEmail}...`);
    ...
    if (event.onlineMeeting) {
        console.log("Online Meeting Data Found in Event:", JSON.stringify(event.onlineMeeting, null, 2));
    } else {
        console.log("No onlineMeeting property in calendar event.");
    }

    if (event.onlineMeetingUrl) {
        console.log("onlineMeetingUrl:", event.onlineMeetingUrl);
    }
}
